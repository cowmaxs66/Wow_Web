...
- 当前版本：v1.19.0
- 当前目标：v1.19.0 进行中，完成 `config.apply`、Client 配置写回、monitor 动态重载和 Web 远程配置面板
...
## 发布归档
v1.19.0 发布资料待归档；上一版 Release：https://github.com/cowmaxs66/Wow_Web/releases/tag/v1.18.0
