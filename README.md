...
- 当前版本：v1.28.0
- 当前目标：v1.28.0 已完成控制面板远程 Client 设置、Lua `return/log()` 回执、回执分类展示、三类编译包和 GitHub Release
...
## 发布归档
当前 v1.28.0 正式测试包已发布：https://github.com/cowmaxs66/Wow_Web/releases/tag/v1.28.0
